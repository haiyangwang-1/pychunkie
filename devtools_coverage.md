...
| 62 | `flamopdimsTest.m` | ✅ 🧪 🚧 ⚠️ | Very Hard | Tests FLAM with multi-operator-dimension Helmholtz systems across two chunkers and compares analytic solution accuracy. | Scalar and simple vector-opdim PyFLAM wiring is active through the generic operator surface, including smooth diagonal shifts. Full two-chunker Helmholtz/block-opdim devtools parity remains pending. |
