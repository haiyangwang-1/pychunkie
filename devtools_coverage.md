...
- Current active verification is `uv run pytest -q`, `34 passed` in
  1.49 seconds, on 2026-05-16.
- GGQ, RCIP, and broader `ChunkGraph` parity remain required milestones.
