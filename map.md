...
Verification snapshot: `uv run pytest` on 2026-05-12 with Python 3.11.9 collected 335 tests: `335 passed`. Full MATLAB parity runs generate ignored `tests/golden/*.mat` files on demand and require a populated `external/chunkie-matlab` checkout.
