...
- Verification snapshot: `uv run pytest` on 2026-05-14 with Python 3.11.9
  collected 376 tests: `376 passed`. Full MATLAB parity runs generate ignored
...
| private helpers | 🧩 ✅ | Internal Python helpers | Chunker/chunker-sequence coercion, weighted density flattening, kernel evaluation, special-quadrature dispatch, dense l2 matrix scaling, RCIP context handling, and normalized keyword-only option handling with temporary dict deprecation warnings. |
