...
- Verification snapshot: `uv run pytest` on 2026-05-14 with Python 3.11.9
  collected 383 tests: `383 passed`. Full MATLAB parity runs generate ignored
...
| `chunkerinterior` | ✅ 🧪 🎯 | `chunkerinterior.m` | Direct point/grid classification is MATLAB-fixture tested; optional Laplace double-layer FMM and FLAM classification use direct close-boundary correction and are Python/devtools-tested, including FLAM keyword options. |
