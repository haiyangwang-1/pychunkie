...
opts_flam_proxy = opts_flam;
opts_flam_proxy.useproxy = true;
opts_flam_proxy.proxybylevel = true;
opts_integral = [];
...
flam_proxy_factor = chunkerflam(chnkr_op, lap_s_kernel, 1.0, opts_flam_proxy);
lap_s_flam_proxy_apply = rskelf_mv(flam_proxy_factor, compressed_rhs);
lap_s_flam_proxy_solve = rskelf_sv(flam_proxy_factor, compressed_rhs);
lap_s_kernel_ifmm = lap_s_kernel;
lap_s_kernel_ifmm.fmm = [];
opts_flam_proxy_eval = [];
opts_flam_proxy_eval.accel = true;
opts_flam_proxy_eval.proxybylevel = true;
opts_flam_proxy_eval.eps = 1e-10;
lap_s_flam_proxy_eval = chunkerkerneval(chnkr_op, lap_s_kernel_ifmm, density_scalar(:), targets, opts_flam_proxy_eval);
...
operator_parity.lap_s_flam_proxy_apply = lap_s_flam_proxy_apply;
operator_parity.lap_s_flam_proxy_solve = lap_s_flam_proxy_solve;
operator_parity.lap_s_flam_proxy_eval = lap_s_flam_proxy_eval;
